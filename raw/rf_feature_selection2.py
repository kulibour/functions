...
def cal_rfg_r2_oob(train_set, base, y_name):
...
class forward_feature_selection(object):
    ...
    def _forward(self, base, criter_value):
        ...
        for fea in self.features:
            ...
            if fea not in new_base:
                new_base.append(fea)
                criter_value1,fea_importance1 = cal_rfg_r2_oob(self.train_set, new_base, self.y_name)
    ...
    def _select_feature(self, base_fea):
        ...
        f.write('features\tr2\n')
        base = [base_fea]
        criter_value,base_importance = cal_rfg_r2_oob(self.train_set, base, self.y_name)
        print(criter_value)
